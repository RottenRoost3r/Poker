...
class Poker < Minitest::Test
    ...
    def test_comparison_full_house_1
        ...
        black.deal(Card.new("6", "C"))
        black.deal(Card.new("6", "D"))
        black.deal(Card.new("5", "C"))

        white.deal(Card.new("5", "S"))
        white.deal(Card.new("5", "C"))
        white.deal(Card.new("6", "S"))
        white.deal(Card.new("6", "H"))
        white.deal(Card.new("6", "C"))
        game = Rules.new
        assert_equal("white wins", game.comparison(black, white))
    end
    ...
    def test_comparison_full_house_2
        ...
        white = Hand.new
        black.deal(Card.new("6", "D"))
        black.deal(Card.new("3", "H"))
        black.deal(Card.new("6", "C"))
        black.deal(Card.new("6", "D"))
        black.deal(Card.new("3", "C"))

        white.deal(Card.new("9", "S"))
        white.deal(Card.new("9", "C"))
        white.deal(Card.new("3", "S"))
        white.deal(Card.new("3", "H"))
        white.deal(Card.new("3", "C"))
        game = Rules.new
        assert_equal("black wins", game.comparison(black, white))
    end

    def test_pair_high_card
        temp = Hand.new
        temp.deal(Card.new("3", "H"))
        temp.deal(Card.new("7", "S"))
        temp.deal(Card.new("5", "C"))
        ...
        temp.deal(Card.new("6", "H"))
        game = Rules.new
        assert_equal(3, game.pair_high_card(temp))
    end

    def test_pair_high_card_2
        temp = Hand.new
        temp.deal(Card.new("2", "H"))
        temp.deal(Card.new("7", "S"))
        temp.deal(Card.new("8", "C"))
        ...
        temp.deal(Card.new("6", "H"))
        game = Rules.new
        assert_equal(8, game.pair_high_card(temp))
    end
    
    def test_comparison_pair_high_card
        black = Hand.new
        white = Hand.new
        black.deal(Card.new("8", "D"))
        black.deal(Card.new("8", "H"))
        black.deal(Card.new("2", "C"))
        black.deal(Card.new("6", "D"))
        black.deal(Card.new("3", "C"))
    ...
    def test_comparison_pair_high_card_two_2
        black = Hand.new
        white = Hand.new
        black.deal(Card.new("8", "D"))
        black.deal(Card.new("8", "H"))
